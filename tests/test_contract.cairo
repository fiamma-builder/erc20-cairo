...
#[generate_trait]
impl EventSpyHelpersImpl of EventSpyHelpers {
    fn assert_event_ownership_transferred(
        ...
        let event = OwnableComponent::Event::OwnershipTransferred(
            OwnableComponent::OwnershipTransferred { previous_owner, new_owner },
        );
        self.assert_emitted_single(contract, event);
    }
    ...
    fn assert_only_event_transfer(
        ...
        let event = ERC20Component::Event::Transfer(ERC20Component::Transfer { from, to, value });
        self.assert_emitted_single(contract, event);
    ...
    fn assert_event_approval(
        ...
        let event = ERC20Component::Event::Approval(
            ERC20Component::Approval { owner, spender, value },
        );
        self.assert_emitted_single(contract, event);
    }
    ...
    fn assert_only_event_upgraded(
        ref self: EventSpy, contract: starknet::ContractAddress, class_hash: ClassHash,
    ) {
